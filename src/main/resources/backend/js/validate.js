...
function checkUserName (rule, value, callback){
  if (value == "") {
    ...
    callback(new Error("The length of user name should be between 3 and 20"))
  } else {
    callback()
  }
}
...
function checkName (rule, value, callback){
  if (value == "") {
    ...
    callback(new Error("The length of name should be between 1 and 12"))
  } else {
    callback()
  }
}
...
function validID (rule,value,callback) {
  ...
  if(value == '') {
    ...
    callback(new Error('ID number incorrect'))
  }
}